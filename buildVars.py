...
addon_info = AddonInfo(
    addon_name="instantTimer",
    addon_summary=_("Instant Timer"),
    addon_description=_(
    ...
    addon_url="https://github.com/kamalyaser31/instantTimer",
    addon_sourceURL="https://github.com/kamalyaser31/instantTimer",
